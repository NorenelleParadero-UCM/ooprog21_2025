...
//I fixed the 1-arg constructor so it also sets departure and mode using default values.
/*
I fixed the 2-arg constructor because it was written wrong (it called two this() which is 
not allowed). Now it correctly calls the 3-arg constructor with a default mode.
*/
